    ...
    <aside className="input-panel">
      ...
      <div className="textarea-wrapper">
        <div className="textarea-label">
          ...
          {problem && (
            <button className="clear-btn" onClick={clearInput} id="clear-problem">
        ...
        <div className="textarea-container">
          ...
          <div className="textarea-footer">
            <span className="char-count" style={{ color: charCount > 1800 ? 'var(--accent-red)' : 'var(--text-muted)' }}>
              {charCount}/2000
            </span>
      ...
      <div className="examples-list">
        {EXAMPLE_PROBLEMS.map((ex, i) => (
          ...
          >
            ...
            <svg className="example-arrow" width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <div className="panel-tip">
        ...
        <span>Be specific about constraints, input types, and expected outputs for best results.</span>
      </div>
    </aside>
  );
};
